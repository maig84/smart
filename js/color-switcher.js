(function ($) {
  ...
  $("#styleOptions .color-default").on("click", function () {
    let thmLogo = "images/colors/color-default/nav-logo.png";
    let dLogo = "images/colors/color-default/logo-dark.png";
    let fLogo = "images/colors/color-default/nav-logo.png";
    let favicon = "images/colors/color-default/favicon.png";
    let error404 = "images/colors/color-default/icons/404-image.png";
